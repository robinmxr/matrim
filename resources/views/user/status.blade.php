    ...
    <div class="row mt-5 mb-5">
        <div>
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="card-title">Your registration has been completed</h4>
              ...
              <div class="mt-3 mb-3 text-center">
                ...
                <a href="{{ route('payment.show') }}"> <button class="btn btn-lg btn-danger profile-button">
                  Pay Now</button></a>
            </div>
                @else
                    <h4 class="card-text">Your Registration Fee Has been Paid.</h4>
                    <p>You will get a notification after admin approval</p>
                    <div class="mt-3 mb-3 text-center">
